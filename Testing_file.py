...
root.title("5_Fruit_Disease_Detection System")
...
#
lbl = tk.Label(root, text="Fruit_Disease_Detection using CNN", font=('times', 35,' bold '), height=1, width=32,bg="yellow",fg="Black")
